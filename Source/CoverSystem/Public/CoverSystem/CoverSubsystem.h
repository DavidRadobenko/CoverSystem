...
DECLARE_CYCLE_STAT_EXTERN(TEXT("Generate Cover / Full"), STAT_GenerateCover, STATGROUP_CoverSystem, COVERSYSTEM_API);
DECLARE_CYCLE_STAT_EXTERN(TEXT("Generate Cover / GenerateCoverInBounds"), STAT_GenerateCoverInBounds, STATGROUP_CoverSystem, COVERSYSTEM_API);
...
DECLARE_CYCLE_STAT_EXTERN(TEXT("Find Cover"), STAT_FindCover, STATGROUP_CoverSystem, COVERSYSTEM_API);
 ...
 */
UCLASS()
class COVERSYSTEM_API UCoverSubsystem : public UWorldSubsystem 
{
	GENERATED_BODY()
